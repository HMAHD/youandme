                        ...
                        <div class="text-lg-right">
                            <a class="fabu" href="/admin/leavP.php">
                                <button type="button" class="btn btn-success mb-2 mr-2"><i
                                        class=" mdi mdi-brightness-5"></i> Message Settings
                                </button>
                            </a>
                        </div>
                    </div><!-- end col-->
                </div>
                <h4 class="header-title mb-3 size_18">Message Management
                    <button type="button" class="btn btn-secondary btn-sm btn-rounded margin_left">
                        general<b><?php echo $leav['shu'] ?></b> Message
                    </button>
                </h4>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <i><?php echo $city ? $city : 'unknown'; ?></i>
                                    </td>
                                    <td>
...
<script>
    function del(id, text) {
        if (confirm('You confirm that you want to delete ' + text + ' content?')) {

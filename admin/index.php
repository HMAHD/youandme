...
// Comment the following to remove all prompts

include_once "LG_Info.php";

// Comment the above to remove all prompts
?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted font-weight-normal mt-0 text-truncate" title="Campaign Sent">Leave a message</h5>
                        <h3 class="my-2 py-1"><?php echo $shu ?><i>🪷</i></h3>
                    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted font-weight-normal mt-0 text-truncate" title="New Leads">The little things</h5>
                        <h3 class="my-2 py-1"><?php echo $diannub ?><i>🪷</i></h3>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="text-muted font-weight-normal mt-0 text-truncate" title="Deals">Love To-Do List</h5>
                        <h3 class="my-2 py-1"><?php echo $listnub ?><i>🪷</i></h3>

...
<script>
    $("#userPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 135) {
                    toastr["success"]("Updating login information was successful!", "You&Me");
                    toastr["success"]("Update Global Information Successful", "You&Me");
                    toastr["success"]("Updating Customized Content Successfully", "You&Me");
                } else if (res == 046) {
                    toastr["error"]("Failed to update login information!", "You&Me");
                    toastr["error"]("Failed to update global information!", "You&Me");
                    toastr["error"]("Failed to update customized content!", "You&Me");
                } else if (res == 7) {
                    toastr["error"]("Security code error!", "You&Me");
                } else {
    ...
    $("#adminPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 13) {
                    toastr["success"]("Basic information updated successfully!", "You&Me");
                    toastr["success"]("Settings updated successfully!", "You&Me");
                } else if (res == 04) {
                    toastr["error"]("Failed to update basic information!", "You&Me");
                    toastr["error"]("Failed to update settings!", "You&Me");
                } else {
                    toastr["error"]("Unknown error!", "You&Me");
                }
            },
    ...
    $("#loveadminPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Couple information updated successfully!", "You&Me");
                } else if (res == 0) {
                    toastr["error"]("Failed to update couple information!", "You&Me");
                } else if (res == 3) {
                    toastr["error"]("Invalid mobile number format!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#CardadminPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Card information updated successfully!", "You&Me");
                } else if (res == 0) {
                    toastr["error"]("Failed to update card information!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#leavPPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Message settings updated successfully!", "You&Me");
                } else if (res == 0) {
                    toastr["error"]("Failed to update message settings!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#littleupda").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Article updated successfully!", "You&Me");
                    $('#littleupda').text('Updating...');
                    $("#littleupda").attr("disabled", "disabled");
                    setInterval("window.location.href='littleSet.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("Failed to update article!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#littleAddPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("New article added successfully!", "You&Me");
                    $('#littleAddPost').text('Publishing...');
                    $("#littleAddPost").attr("disabled", "disabled");
                    setInterval("window.location.href='littleSet.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("Failed to add new article!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#ImgUpdaPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Album updated successfully!", "You&Me");
                    $('#ImgUpdaPost').text('Updating...');
                    $("#ImgUpdaPost").attr("disabled", "disabled");
                    setInterval("window.location.href='loveImgSet.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("Failed to update album!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#ImgAddPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("New album added successfully!", "You&Me");
                    $('#ImgUpdaPost').text('Adding...');
                    $("#ImgUpdaPost").attr("disabled", "disabled");
                    setInterval("window.location.href='loveImgSet.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("Failed to add new album!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#listaddPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("New event added successfully!", "You&Me");
                    $('#listaddPost').text('Adding...');
                    $("#listaddPost").attr("disabled", "disabled");
                    setInterval("window.location.href='lovelist.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("Failed to add new event!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#ipAddPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("IP ban successful!", "You&Me");
                    $('#listupda').text('Submitting...');
                    $("#listupda").attr("disabled", "disabled");
                    setInterval("window.location.href='ipList.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("IP ban failed!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#listupda").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Event updated successfully!", "You&Me");
                    $('#listupda').text('Updating...');
                    $("#listupda").attr("disabled", "disabled");
                    setInterval("window.location.href='lovelist.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("Event update failed!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");
    ...
    $("#aboutPost").click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res == 1) {
                    toastr["success"]("Dialog configuration updated successfully!", "You&Me");
                } else if (res == 0) {
                    toastr["error"]("Dialog configuration update failed!", "You&Me");
                }
            },
            error: function(err) {
                toastr["error"]("Network error, please try again later!", "You&Me");

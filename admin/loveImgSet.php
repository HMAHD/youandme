...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3 size_18">Love Album<a href="/admin/loveImgAdd.php">
...
<script>
    function del(id, imgText) {
        if (confirm('You confirm that you want to delete the file described as ' + imgText + ' The pictures in the album?')) {

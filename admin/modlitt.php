...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3 size_18">Modify the article - <?php echo $mod['articletitle'] ?></h4>
                ...
                <form class="needs-validation" action="littleupda.php" method="post" onsubmit="return check()"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input name="articletitle" type="text" class="form-control" id="validationCustom01"
                            placeholder="Please enter a title" value="<?php echo $mod['articletitle'] ?>" required>
                    </div>
                    <div id="test-editor">
                    ...
                    <div class="form-group mb-3 text_right">
                        ...
                        <button class="btn btn-primary" type="button" id="littleupda">Modify Release</button>
                    </div>
                </form>

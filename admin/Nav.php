...
<head>
    <meta charset="utf-8" />
    <title>Backend management — <?php echo $text['title'] ?></title>
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown"
                        ...
                        <span>
                            ...
                            <span class="account-position">operation</span>
                        </span>
                    </a>
        ...
        <div class="wrapper">
            ...
            <div class="left-side-menu">
                ...
                <div class="help-box text-center">
                    ...
                    <h5 class="mt-3">You&Me V2.0</h5>
                    <p class="mb-3">Meeting you is the beginning of all stories 🎉</p>
                    <a href="https://diary.us.kg/youandme" target="_blank" class="btn btn-outline-primary btn-sm">documentation</a>
                </div>
                <!-- end Help Box -->
                <!-- End Sidebar -->
